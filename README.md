<h1>Task Management System with AI Integration</h1>
...
<h3>★ Create a `.env` file in the root directory and add your Google Gemini API key (make sure to delete `.env.example` or add same environment variables to `.env.example` before running the developement server) :</h3>
